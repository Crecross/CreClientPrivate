...
namespace CreClientTest
{
    class Fly : BaseModule, OnUpdateEvent
    {
        ...
        public Fly() : base("Fly", "Fly high", Main_BlazeAPI.Instance.movementGroup, null, true)
        {
        }
        ...
        public override void OnEnable()
        {
            ...
            Main_BlazeAPI.Instance.onUpdateEvents.Add(this);
        }

        public override void OnDisable()
        {
            Main_BlazeAPI.Instance.onUpdateEvents.Remove(this);
